...
service. It ships a single governance skill SKILL.md with supporting CI tooling
(3 Python scripts under `scripts/`). If you find an issue with the content or CI
configuration, please open a public issue on GitHub.
